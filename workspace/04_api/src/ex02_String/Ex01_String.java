...
public class Ex01_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(a == b); // 참조 비교(주소 비교)
		...
		// 2) substring(시작인덱스, 종료인덱스): 시작인덱스 <= 추출 < 종료인덱스
		System.out.println(a.substring(0, 3)); // app (사용인덱스: 0, 1, 2)

		// 5. 문자열 양 옆의 공백문자(white space)를 제거하려면 trim() 메소드를 사용합니다.
		String name = "    alice     ";
		System.out.println(name.trim().length()); // 양 옆 공백을 모두 제거하고 alice만 남깁니다.
		...
		// 8. 기존 문자를 새로은 문자로 변경하는 replace() 메소드가 있습니다.
