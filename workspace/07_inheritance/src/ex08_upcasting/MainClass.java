...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Elec elec = tv; // Tv 타입의 객체를 Elec 타입으로 변경
						// 서브 -> 수퍼 타입으로 변경하는 것으로 "upcasting"이라고 합니다.
		...
		// 		 Elec elec = tv; 이므로 elec.info()는 Elec의 info()입니다. => 정적 바인딩
		//	  2) 실제 객체를 확인합니다.
		//       Tv tv = new Tv(200, "LG-75"); 이므로 tv 객체가 Tv 타입이라는 것을 확인합니다.
		//    3) 실제 객체의 타입으로 바꿔서 호출하고 실행합니다.
		//       elec.info()가 실행될때는 Tv의 info()가 호출됩니다. => 동적 바인딩
		
		Elec elec2 = new Tv(300, "Sansumg-85");
		elec2.info();
